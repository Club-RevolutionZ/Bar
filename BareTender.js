/** Final part of the autoskip fix.
        ...
        commands: {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.profile, {nameto: user.username.toLowerCase().replace(/ /g, "-"), namefrom: chat.un, profile: this.getProfile()}));
                            }
                        }
                    }
                }
            ...
            diceCommand: {
                ...
                dices: ['has rolled an One. https://imageshack.com/a/img538/9612/nkX6X3.gif',
                    ...
                    'has rolled an One. https://imageshack.com/a/img538/9612/nkX6X3.gif',
                    'has rolled an One. https://imageshack.com/a/img538/9612/nkX6X3.gif',
                    'has rolled a Two. https://imageshack.com/a/img540/8616/pzrH5R.gif',
                    'has rolled a Two. https://imageshack.com/a/img540/8616/pzrH5R.gif',
                    'has rolled a Two. https://imageshack.com/a/img540/8616/pzrH5R.gif',
                    'has rolled a Two. https://imageshack.com/a/img540/8616/pzrH5R.gif',
                    'has rolled a Two. https://imageshack.com/a/img540/8616/pzrH5R.gif',
                    'has rolled a Three. https://imageshack.com/a/img674/7615/FCpxMK.gif',
                    'has rolled a Three. https://imageshack.com/a/img674/7615/FCpxMK.gif',
                    'has rolled a Three. https://imageshack.com/a/img674/7615/FCpxMK.gif',
                    'has rolled a Three. https://imageshack.com/a/img674/7615/FCpxMK.gif',
            ...
            fbCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var msg = chat.message;
                        if (msg.length <= cmd.length + 1) return API.sendChat('/me ' + basicBot.settings.fbLink);
